...
<head>
    ...
    <meta name="twitter:title" content="Quick tip: Fix Flash audio stutter on Fedora 14 (64bit)">
    <meta name="twitter:description" content="">
    <meta name="twitter:site" content="@username">
	<meta name="twitter:creator" content="@username">

    <meta property="og:type" content="article">
    <meta property="og:title" content="Quick tip: Fix Flash audio stutter on Fedora 14 (64bit)">
...
<link rel="canonical" href="http://localhost:5000//2011/02/24/quick-tip-fix-flash-audio-stutter-on-fedora-14-64bit.md" />	
</head>
	...
	<section class="post-full">
		<article itemscope itemtype="http://schema.org/BlogPosting" role="article" class="post">
    		...
    		<section itemprop="articleBody" class="post-content">
    			<p>On my FC14 machine, I had a problem with Flash (64bit) audio playback: the sound on sites other than Youtube would stutter terribly. It appears that this a systematic problem; but luckily there is a fix!</p>
