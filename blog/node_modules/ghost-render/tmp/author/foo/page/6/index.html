...
<link rel="prev" href="http://localhost:5000/page/5/" />
<link rel="next" href="http://localhost:5000/page/7/" />	
</head>
	...
	<section class="post-list">
		<article itemscope itemtype="http://schema.org/BlogPosting" role="article" class="post">
    		...
    		<section itemprop="description" class="post-excerpt">
    			<p>I am implementing Facebook single sign on for my applications. In this first part of my Facebook authentication tutorial, I discuss the basics of the Facebook authentication process (see also: part 2, part 3). Getting started: some terminology If you are like me and haven&#39;t implemented Facebook integration&hellip;</p>
    		</section>
		</article>
		<article itemscope itemtype="http://schema.org/BlogPosting" role="article" class="post">
			<header class="post-header">        		
    			<h2 itemprop="name" class="post-title">
    				<a href="/2010/12/22/5-principles-of-web-application-development-productivity.html" itemprop="url">5 principles of web application development productivity</a>
    			</h2>
    			<div class="post-meta">
        			<time datetime="2010-12-22" itemprop="datePublished">December 22, 2010</time>
        		</div>
        		<hr>
    		</header>
    		<section itemprop="description" class="post-excerpt">
    			<p>My early New Year&#39;s resolution is to ship more next year (why wait for next year to start?). With this in mind, I decided to write about increasing productivity in web app development (more posts coming!). In this first part, I will look at the principles behind getting&hellip;</p>
    		</section>
		</article>
		<article itemscope itemtype="http://schema.org/BlogPosting" role="article" class="post">
			<header class="post-header">        		
		...
		<article itemscope itemtype="http://schema.org/BlogPosting" role="article" class="post">
    		...
    		<section itemprop="description" class="post-excerpt">
    			<p>Does deploying changes to your site take too long? Are you tired of manually sorting out the update? Here is how to deploy your projects using Mercurial. Why?     Ease of updating. Mercurial keeps track of the changes and only sends the necessary changes -  you don&#39;t need to&hellip;</p>
    		</section>
		</article>
		<article itemscope itemtype="http://schema.org/BlogPosting" role="article" class="post">
			<header class="post-header">        		
    			<h2 itemprop="name" class="post-title">
    				<a href="/2010/11/22/how-to-get-google-docs-to-full-screen-view-get-rid-of-the-stuff-on-top-of-the-page.html" itemprop="url">How to get Google Docs to full screen view (get rid of the stuff on top of the page)</a>
    			</h2>
    			<div class="post-meta">
        			<time datetime="2010-11-22" itemprop="datePublished">November 22, 2010</time>
        		</div>
        		<hr>
    		</header>
    		<section itemprop="description" class="post-excerpt">
    			<p>I find that I am using Google Docs a lot more these days. A major annoyance is that the Google logo and other useless tools take up space from the page, so I came up with the following simple bookmarklet: GDocs toggle Just grab the link with your mouse, and&hellip;</p>
    		</section>
		</article>

		<nav class="pagination" role="pagination">
        <a class="newer-posts" href="/author/foo/page/5/">&laquo; Newer</a>
        <a class="older-posts" href="/author/foo/page/7/">Older &raquo;</a>
</nav>
	</section>
