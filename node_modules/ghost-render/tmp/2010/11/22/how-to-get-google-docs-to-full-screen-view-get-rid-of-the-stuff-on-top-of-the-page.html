...
<head>
    ...
    <meta name="twitter:title" content="How to get Google Docs to full screen view (get rid of the stuff on top of the page)">
    <meta name="twitter:description" content="">
    <meta name="twitter:site" content="@username">
	<meta name="twitter:creator" content="@username">

    <meta property="og:type" content="article">
    <meta property="og:title" content="How to get Google Docs to full screen view (get rid of the stuff on top of the page)">
...
<link rel="canonical" href="http://localhost:5000//2010/11/22/how-to-get-google-docs-to-full-screen-view-get-rid-of-the-stuff-on-top-of-the-page.md" />	
</head>
	...
	<section class="post-full">
		<article itemscope itemtype="http://schema.org/BlogPosting" role="article" class="post">
    		...
    		<section itemprop="articleBody" class="post-content">
    			<p>I find that I am using Google Docs a lot more these days. <strong>A major annoyance</strong> is that the Google logo and other useless tools take up space from the page, so I came up with the following simple bookmarklet:</p>
