...
<head>
    ...
    <meta name="twitter:title" content="Quick tip: Netbeans is excluding / ignoring directories in version control">
    <meta name="twitter:description" content="">
    <meta name="twitter:site" content="@username">
	<meta name="twitter:creator" content="@username">

    <meta property="og:type" content="article">
    <meta property="og:title" content="Quick tip: Netbeans is excluding / ignoring directories in version control">
...
<link rel="canonical" href="http://localhost:5000//2010/07/10/quick-tip-netbeans-is-excluding-ignoring-directories-in-version-control.md" />	
</head>
	...
	<section class="post-full">
		<article itemscope itemtype="http://schema.org/BlogPosting" role="article" class="post">
    		...
    		<section itemprop="articleBody" class="post-content">
    			<p>Is Netbeans not showing the version control options correctly for some of your directories? Check whether you have accidentally left .svn directories. All source control system directories are hidden by default in Netbeans, which makes spotting this a bit tricky.</p>
